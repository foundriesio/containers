...
Real-time object detection using Edge Impulse on Arduino Uno Q
"""
    ...
    while camera_running:
        ...
        if last_detections:
            for obj_det in last_detections:
                ...
                cv2.rectangle(display_frame, (x1, y1 - label_h - 5), (x1 + label_w, y1), (0, 255, 0), -1)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Object Detection Server with Edge Impulse')
    parser.add_argument(
        '--model',
        type=str,
        default=None,
    ...
    print("=" * 60)
    print("Edge Impulse Object Detection Server")
    print("=" * 60)
